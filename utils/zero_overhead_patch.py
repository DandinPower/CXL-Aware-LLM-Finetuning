...
def patch_deepspeed_zero_overhead_pinned_memory():
    print("[INIT] Apply zero overhead pinned memory deepspeed")
...
def patch_cpu_lion_zero_overhead_pinned_memory():
    print("[INIT] Apply zero overhead pinned memory for CPU LION optimizer")
    cpu_lion.CPULion.zeros_cpu_for_momentums = _zeros_cpu_zero_overhead